 ...
 * UPDATE MỚI: Thêm lệnh renderSamplePrescriptionSettings() khi mở cài đặt.
...
window.openSettings = function() {
    ...
    // 5. Gọi các hàm render dữ liệu con
    ...
    // [FIX] Render danh sách bài thuốc mẫu
    if(window.renderSamplePrescriptionSettings) window.renderSamplePrescriptionSettings();
};
...
window.openBackupModalDirect = function() {
    ...
    if (modal) {
        ...
        // Đảm bảo z-index cao hơn modal cài đặt
