            ...
            <div id="step3" class="step-content hidden space-y-6">
                ...
                <div class="bg-white p-4 border border-[#d7ccc8] rounded-2xl shadow-sm">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-3">
                        <button onclick="window.openHerbModal()" class="py-3 bg-[#fff8e1] text-[#f57f17] text-xs font-bold rounded-xl border border-[#ffe082] hover:bg-[#ffecb3] transition-colors flex items-center justify-center gap-2 shadow-sm">
                            <span>🌿 Tra cứu Dược & AI</span>
                        </button>
                        <button onclick="window.showSamplePrescriptionPopup(this)" class="py-3 bg-[#eceff1] text-[#455a64] text-xs font-bold rounded-xl border border-[#cfd8dc] hover:bg-[#b0bec5] transition-colors flex items-center justify-center gap-2 shadow-sm">
                            <span>📚 Bài thuốc mẫu</span>
                        </button>
                    </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-dashed border-[#d7ccc8]">
                        ...
                        <div class="med-usage-row mb-4" id="globalEastTimeGroup">
