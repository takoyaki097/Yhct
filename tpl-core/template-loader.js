 ...
 * CẬP NHẬT: Thêm giao diện Phòng Lab Biện Chứng (tplLab) vào hệ thống DOM.
 */
...
window.loadAllModals = function() {
    ...
    // [CẬP NHẬT] Thêm Template Lab vào hệ thống
    const tplLab = window.TPL_LAB || ""; 
